...
const CACHE='avtovip-v24-20260916-ui-chat';
const CORE=['./','index.html','assets/css/app.css?v=20','assets/css/patch11.css?v=20','assets/css/ui-pro.css?v=24','assets/js/supabase.js','assets/js/international.js','assets/js/app.js?v=20','assets/js/social.js?v=20','assets/js/patch11.js?v=20','assets/js/ui-pro.js?v=24','assets/img/brand/icon-192.png'];
