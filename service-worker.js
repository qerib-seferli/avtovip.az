const CACHE='avtovip-v121-profile-center';
const STATIC=[
  './assets/css/app.css','./assets/css/patch11.css','./assets/css/ui-pro.css','./assets/css/profile-final.css',
  ...
  './assets/img/brand/logo.png','./assets/img/brand/icon-192.png','./assets/img/profile/world-map.svg','./assets/img/brand/icon-512.png','./assets/img/identity/vip-frame.svg','./assets/img/identity/premium-frame.svg','./site.webmanifest'
];
