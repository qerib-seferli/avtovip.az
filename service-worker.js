const CACHE='avtovip-shell-v4-20260914';
const SHELL=['./','./index.html','./assets/css/app.css','./assets/js/supabase.js','./assets/js/international.js','./assets/js/app.js','./assets/img/brand/icon-192.png'];
