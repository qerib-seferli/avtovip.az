...
(() => {
  ...
  async function initProfile(){
    ...
    const nameBox=$('#profileName'); if(profile?.is_verified&&nameBox&&!nameBox.querySelector('.verified-mark'))nameBox.insertAdjacentHTML('afterbegin','<span class="verified-mark verified-rosette av-verified-left profile-verified" title="Təsdiqlənmiş hesab"><i class="fa-solid fa-check"></i></span>');
