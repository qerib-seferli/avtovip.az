  ...
  async function openStory(s,p={},storyList=[],storyProfiles={}){
    ...
    try{
      ...
      if(!vr.error&&Number.isFinite(Number(vr.data)))registeredStoryViews=Number(vr.data);
        ...
        await sb.from('story_views').insert(viewRow);
      }
